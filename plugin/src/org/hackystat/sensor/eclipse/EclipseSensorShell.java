 ...
 * @version $Id: EclipseSensorShell.java,v 1.1.1.1 2005/10/20 23:56:56 johnson Exp $
 */
public class EclipseSensorShell {
   ...
   */
  EclipseSensorShell(SensorProperties sensorProperties) {
   ...
   * @param msg Message to display in the status bar for monitoring.
   */
  public void doCommand(final String command, final List args, String msg) {
    if (this.shell != null) {
      if (this.isEnabled && this.isMonitorEnabled) {
        processStatusLine("Hackystat Sensor : " + msg);
      }
